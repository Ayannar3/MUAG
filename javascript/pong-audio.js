...
export var wallSound = new soundFile("spoon.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("boing.mp3");
...
export var adventureMusic = new soundFile("water_rain2.mp3");
